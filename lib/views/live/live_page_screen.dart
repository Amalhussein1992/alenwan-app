    ...
    return Scaffold(
      ...
      body: Consumer2<LiveController, ChannelController>(
        builder: (context, liveC, chC, _) {
          ...
          final liveNowStreams = streams
              .where((s) => _isLiveNow(s, now))
              .toList();
          final comingSoonStreams = streams
              .where((s) => _isComingSoon(s, now))
              .toList();
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              Colors.transparent,
                              ProfessionalTheme.backgroundColor.withValues(
                                alpha: 0.9,
                              ),
                            ],
                          ),
                      ...
                      Positioned(
                        ...
                        child: Text(
                          ...
                          style:
                              ProfessionalTheme.headlineSmall(
                                color: Colors.white,
                              ).copyWith(
                                shadows: [
                                  Shadow(
